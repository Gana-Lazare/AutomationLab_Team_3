...
//from here we will set the propreties, path ,WebDriver  and befor and after Method//
   ...
   public static WebDriver driver = null;
    ...
    public static String convertToString(String st) {
        String splitString = "";
        splitString =
                StringUtils.join(StringUtils.splitByCharacterTypeCamelCase(st), ' ');
        return splitString;
    }
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver","../Generic/Browser/chrome/chromedriver");
            ...
            System.setProperty("webdriver.ie.driver","/Users/khaledmaouche/IdeaProjects/AutomationLab_Team_3/Generic/Browser/chrome/geckodriver");
    ...
    public void openBrowser() throws IOException {
        setUp(false,"browserstack","OS X","10","chrome","85","https://www.amazon.com");
    }

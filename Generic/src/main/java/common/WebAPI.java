...
//    }
    ...
    //Browser SetUp
    public static WebDriver driver = null;
    public String browserstack_username = "hassanari1";
    public String browserstack_accesskey = "oy1tghxyn2xqZ5fwiwri";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("OS X") String os, @Optional("catalina") String os_version, @Optional("chrome") String browserName, @Optional("85")
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "/Users/elhacenarib/IdeaProjects/AutomationLab_Team_3/Generic/Browser/chrome/chromedriver");

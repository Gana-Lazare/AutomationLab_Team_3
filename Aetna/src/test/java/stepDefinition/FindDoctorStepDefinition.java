...
import FindDoctorPage.FindDoctor;
...
public class FindDoctorStepDefinition extends WebAPI {
    static FindDoctor homePage;
    @After
    ...
    public static void getInit(){
        homePage= PageFactory.initElements(driver, FindDoctor.class);
    }
    ...
    public void I_click_find_doctor2() {
        homePage.submitFindDoctor();
    }
//    @Then("user enter\"(.*)\" and \"(.*)\"")
